...
#define error real_error		// no variadic macro in vc6
...
#define error_msg real_error_msg		// no variadic macro in vc6
...
#define pexit real_pexit	// no variadic macro in vc6
...
#ifdef WINDOZE
const char *jtr_lltoa( __int64 num, char *result, int result_len, int base);
const char *jtr_ulltoa(unsigned __int64 num, char *result, int result_len, int base);
#else	// WINDOZE
